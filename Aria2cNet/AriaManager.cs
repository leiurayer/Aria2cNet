using Aria2cNet.Client;
using Aria2cNet.Client.Models;
using System;
        ...
        public DownloadResult GetDownloadStatus(string gid, Action action = null)
        {
            ...
            while (true)
            {
                ...
                if (status.Result.Result.ErrorCode != null && status.Result.Result.ErrorCode != "0")
                {
                    ...
                    {
                        Log.Logger.Error("AriaManager", status.Result.Result.ErrorMessage);
                    }
                    ...
                    {
                        Log.Logger.Debug("AriaManager", ariaRemove1.Result.Result);
                    }
